...
import com.aotter.max.mediation.demo.databinding.ActivityBannerAdBinding
...
class BannerAdActivity : AppCompatActivity() {
    ...
    private lateinit var viewBinding: ActivityBannerAdBinding

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        viewBinding = ActivityBannerAdBinding.inflate(layoutInflater)
