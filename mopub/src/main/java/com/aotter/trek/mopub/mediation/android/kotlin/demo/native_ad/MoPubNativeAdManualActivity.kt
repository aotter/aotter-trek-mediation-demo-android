...
import com.aotter.trek.sdk.android.mopub.mediation.kotlin.demo.databinding.ActivityMoPubNativeAdManualBinding
...
class MoPubNativeAdManualActivity : AppCompatActivity() {

    private lateinit var viewBinding: ActivityMoPubNativeAdManualBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding = ActivityMoPubNativeAdManualBinding.inflate(layoutInflater)
    ...
    private fun getAd() {
        ...
        val moPubNative =
            MoPubNative(this, "ceb4fab764664aa2934e4e9f82766e88", moPubNativeNetworkListener)
